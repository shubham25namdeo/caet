...
urlpatterns = [
    ...
    url(r'^$', 'first_app.views.home'),
    url(r'^team/$', 'first_app.views.team'),
    url(r'^vid/$', 'first_app.views.vid'),
    ...
    url(r'^vctant/$', ('first_app.views.view_consultant')),
    url(r'^edctant/$', ('first_app.views.edit_consultant'))
